...
function exemplo2() {
    let conta = Number(prompt("informe a quantidade de idades: "))
    let soma = 0
    let contador = 1
...
function ex2parandonolucromax() {
    ...
    while (ving >= 1.00 && val == true) {
        ...
        console.log("  ")
        ingi = ingi - 0.50
        if (lucro < lucroAntigo) {
            console.log("Lucro máximo obtido: ", lucro)
            val = false
        }
        lucroAntigo = lucro
    }
...
function ex22() {
    ...
    let idade = 0, alt = 0, totalAlt = 0, medAlt = 0, id50 = 0
    do {

        idade = Number(prompt(`Informe sua idade: `))
        alt = Number(prompt(`Informe sua altura: `))
    ...
    medAlt = totalAlt / id50
    alert(`A média de altura das pessoas acima de 50 anos é ${medAlt}`)
}
